...
syn keyword tmuxColor black red green yellow blue magenta cyan white
syn keyword tmuxAttr default bright bold dim underscore blink reverse hidden italics
...
syn keyword tmuxOptsSet message-bg lock-after-time default-path message-fg
...
syn keyword tmuxOptsSet mouse-resize-pane renumber-windows visual-silence
...
syn keyword tmuxKeyTable vi-edit emacs-edit vi-choice emacs-choice vi-copy emacs-copy
...
hi def link tmuxAttr                Keyword
hi def link tmuxColor               Keyword
hi def link tmuxCmds                Keyword
hi def link tmuxKeyTable            Keyword
